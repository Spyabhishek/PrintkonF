...
import { usePopularProducts } from "../../../shared/hooks/usePopularProducts";

const PopularProducts = () => {
    const scrollRef = useRef(null);
    const { data: response = {}, isLoading, isError } = usePopularProducts(8);
    ...
    return (
        <section className="py-12 bg-gray-50 dark:bg-gray-800 relative">
            <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold text-center mb-8 text-gray-800 dark:text-white">
                    Popular Products
                </h2>
                ...
                <div className="relative">
                    ...
                    <button
                        onClick={() => scroll("left")}
                        className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white dark:bg-gray-800 shadow-md p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                    ...
                    <button
                        ...
                        className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white dark:bg-gray-800 shadow-md p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
